...
const { data: user } = useFetch(`/api/user?role=siswa&user=${nis}`);
</script>
<template>
      ...
      <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        ...
        <div v-if="user" class="mt-4">
          ...
          <!-- <div
            ...
            <div
              class="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
              <span class="font-semibold text-white">129K</span>
              <span class="text-sm">Followers</span>
            </div>
            <div class="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
              <span class="font-semibold text-white">2K</span>
              <span class="text-sm">Following</span>
            </div>
          </div>
  
          <div class="mx-auto max-w-180">
            <h4 class="font-medium text-white">About Me</h4>
          ...
          <div class="mt-6.5">
            <h4 class="mb-3.5 font-medium text-white">Follow me on</h4>
