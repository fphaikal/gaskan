...
export const Icon: React.FC<IconProps> = ({
  ...
  if (
    iconKey === 'mingcute:ins-line' ||
    iconKey === 'mage:instagram-circle' ||
    iconKey === 'instagram' ||
    iconKey === 'Instagram'
  ) {
    return (
  ...
  if (
    iconKey === 'mingcute:linkedin-line' ||
    iconKey === 'entypo-social:linkedin-with-circle' ||
    iconKey === 'linkedin' ||
    iconKey === 'Linkedin'
  ) {
    return (
